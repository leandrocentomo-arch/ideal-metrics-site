...
/* 22/09: «quero que os desenhos se encontrem». Sem vao: a foto entra 90px sobre a
   borda do esquema, POR CIMA (a trama dos circulos e um canvas opaco, e por baixo
   dela a foto sumia numa quina), com a borda esquerda esfumada e sem receber o
   mouse (pointer-events:none: o hover dos temas continua); o rastro do mouse nela
   vem do motor, que escuta a janela. */
.ar-foto{position:relative;min-height:300px;overflow:hidden;z-index:3;margin-left:-90px;pointer-events:none;
...
def secao(L):
    return '\n'.join([
        ...
        arcos.lista(),
        '  </div>',
        '  <div class="ar-foto" aria-hidden="true"><img src="img/conhecimento-paginas-bayer.webp?v=2" '
        'data-lum="img/conhecimento-paginas-lum.webp?v=2" alt="" width="1200" height="800" loading="lazy" decoding="async"></div>',
        '  </div>',
        '</section>',
    ])
